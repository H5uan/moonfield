...
pub trait Instance {
    ...
    fn create_surface(&self, window: &Window) -> Result<Arc<dyn Surface>, RhiError>;
...
pub fn create_instance(backend: crate::types::Backend) -> Result<Arc<dyn Instance>, RhiError> {
...
pub fn create_instance_with_window(backend: crate::types::Backend, window: &Window) -> Result<Arc<dyn Instance>, RhiError> {
    ...
    match backend {
        ...
        crate::types::Backend::Vulkan => {
            ...
            Ok(Arc::new(crate::backend::vulkan::VulkanInstance::new_with_display(display)?))
        }
        #[cfg(target_os = "macos")]
        crate::types::Backend::Metal => {
