...
/// Shader stage flags. Const-fn combinable, no external deps (the push-
/// constant counterpart of `bind::ShaderStage`, which names a single stage).
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
...
/// A push-constant range declared by a pipeline layout.
#[derive(Debug, Clone, Copy)]
pub struct PushConstantRange {
    /// The stages that may read the range.
