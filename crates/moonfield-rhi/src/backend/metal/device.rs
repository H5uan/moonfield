...
use crate::{
    Buffer, CommandPool, Device, Pipeline, Queue, RhiError, ShaderModule,
    Swapchain, types::*,
};
...
impl Device for MetalDevice {
    ...
    fn create_pipeline(
        ...
        unsafe {
            ...
            let vs = vs_any
                .downcast_ref::<super::shader_module::MetalShaderModule>()
                .unwrap();
            ...
            let vs_func_name =
                objc2_foundation::NSString::from_str("vertex_main");
            let vs_func = vs
                .library
            ...
            let fs_func_name =
                objc2_foundation::NSString::from_str("fragment_main");
            let fs_func = fs
                .library
