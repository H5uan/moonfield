...
use crate::{CommandBuffer, RenderPassDescriptor, SwapchainImage, types::*};

pub struct MetalCommandBuffer {
    pub command_buffer: objc2::rc::Retained<
        objc2::runtime::ProtocolObject<dyn objc2_metal::MTLCommandBuffer>,
    >,
    pub current_encoder: Option<
        objc2::rc::Retained<
            objc2::runtime::ProtocolObject<
                dyn objc2_metal::MTLRenderCommandEncoder,
            >,
        >,
    >,
}
...
impl CommandBuffer for MetalCommandBuffer {
    ...
    fn bind_pipeline(&self, pipeline: &dyn crate::Pipeline) {
        ...
        let metal_pipeline = pipeline_any
            .downcast_ref::<super::pipeline::MetalPipeline>()
            .unwrap();
    ...
    fn bind_vertex_buffer(&self, buffer: &dyn crate::Buffer) {
        ...
        let metal_buffer =
            buffer_any.downcast_ref::<super::buffer::MetalBuffer>().unwrap();
