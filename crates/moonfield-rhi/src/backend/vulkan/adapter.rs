    ...
    fn request_device(&self) -> Result<Arc<dyn Device>, RhiError> {
        ...
        unsafe {
            let queue_family_properties =
                self.instance.get_physical_device_queue_family_properties(
            ...
            let queue_family_index = queue_family_properties
                ...
                .ok_or_else(|| {
                    ...
                    RhiError::DeviceCreationFailed(
                        "No suitable graphics queue family found".to_string(),
                    )
                })?;

            tracing::debug!(
                "Found graphics queue family at index: {}",
                queue_family_index
            );
            ...
            let device_extension_names = [
                ...
                ash::vk::EXT_ROBUSTNESS2_NAME.as_ptr(),
