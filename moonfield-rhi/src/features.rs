...
bitflags_array! {
    ...
    ///
    /// These are either part of the standard, or are extension features supported
    ...
    /// Features that are not guaranteed to be supported.
    ///
    /// Most of these are native-only extension features. For all features see [`Features`].
    ///
    /// If you want to use a feature, you need to first verify that the adapter supports
    /// the feature. If the adapter does not support the feature, requesting a device with it enabled
    /// will panic.
    ...
    pub struct FeaturesWGPU features_wgpu {
        ...
        //
        // ? const FORMATS_TIER_1 = 1 << ??;
        // ? const RW_STORAGE_TEXTURE_TIER_1 = 1 << ??;
        // ? const NORM16_FILTERABLE = 1 << ??;
        // ? const NORM16_RESOLVE = 1 << ??;
        // ? const FLOAT32_BLENDABLE = 1 << ??;
        // ? const 32BIT_FORMAT_MULTISAMPLE = 1 << ??;
        // ? const 32BIT_FORMAT_RESOLVE = 1 << ??;
        // ? const TEXTURE_COMPRESSION_ASTC_HDR = 1 << ??;
        // TEXTURE_FORMAT_16BIT_NORM & TEXTURE_COMPRESSION_ASTC_HDR will most likely become features as well
        ...
        ///
        /// By default only basic texture format properties are allowed.
        ...
        /// By default, MAP_READ and MAP_WRITE buffer usage must be matched with
        ...
        /// it represents external texture functionality.
    ...
    /// Features that are not guaranteed to be supported.
    ///
    /// These are standard rendering features. For all features, see [`Features`].
    ///
    /// If you want to use a feature, you need to first verify that the adapter supports
    /// the feature. If the adapter does not support the feature, requesting a device with it enabled
    /// will panic.
    ...
    pub struct FeaturesWebGPU features_webgpu {
        ...
        const DEPTH_CLIP_CONTROL = MOONFEILD_FEATURE_DEPTH_CLIP_CONTROL;
        ...
        const DEPTH32FLOAT_STENCIL8 = MOONFEILD_FEATURE_DEPTH32FLOAT_STENCIL8;
        ...
        ///
        /// This is a web and native feature.
        const TEXTURE_COMPRESSION_BC = MOONFEILD_FEATURE_TEXTURE_COMPRESSION_BC;
        ...
        ///
        /// This is a web and native feature.
        const TEXTURE_COMPRESSION_BC_SLICED_3D = MOONFEILD_FEATURE_TEXTURE_COMPRESSION_BC_SLICED_3D;
        ...
        ///
        /// This is a web and native feature.
        const TEXTURE_COMPRESSION_ETC2 = MOONFEILD_FEATURE_TEXTURE_COMPRESSION_ETC2;
        ...
        ///
        /// This is a web and native feature.
        const TEXTURE_COMPRESSION_ASTC = MOONFEILD_FEATURE_TEXTURE_COMPRESSION_ASTC;
        ...
        ///
        /// This is a web and native feature.
        const TEXTURE_COMPRESSION_ASTC_SLICED_3D = MOONFEILD_FEATURE_TEXTURE_COMPRESSION_ASTC_SLICED_3D;
        ...
        const TIMESTAMP_QUERY = MOONFEILD_FEATURE_TIMESTAMP_QUERY;
        ...
        ///
        /// This is a web and native feature.
        const INDIRECT_FIRST_INSTANCE = MOONFEILD_FEATURE_INDIRECT_FIRST_INSTANCE;
        ...
        ///
        /// This is a web and native feature.
        const SHADER_F16 = MOONFEILD_FEATURE_SHADER_F16;
        ...
        const RG11B10UFLOAT_RENDERABLE = MOONFEILD_FEATURE_RG11B10UFLOAT_RENDERABLE;
        ...
        const BGRA8UNORM_STORAGE = MOONFEILD_FEATURE_BGRA8UNORM_STORAGE;
        ...
        ///
        /// This is a web and native feature.
        const FLOAT32_FILTERABLE = MOONFEILD_FEATURE_FLOAT32_FILTERABLE;
        ...
        ///
        /// This is a web and native feature.
        const DUAL_SOURCE_BLENDING = MOONFEILD_FEATURE_DUAL_SOURCE_BLENDING;
        ...
        ///
        /// This is a web and native feature.
        const CLIP_DISTANCES = MOONFEILD_FEATURE_CLIP_DISTANCES;
    }
}
